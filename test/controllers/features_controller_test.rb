...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { artist_id: @feature.artist_id, video_id: @feature.video_id } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { artist_id: @feature.artist_id, video_id: @feature.video_id } }
